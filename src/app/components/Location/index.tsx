...
const Location = () => {
  return (
    <section className="flex flex-col justify-between bg-[#EDE4DF] lg:flex-row">
      <div className="z-1 mx-8 my-15 flex flex-wrap gap-15 sm:mt-[5.15rem] sm:ml-12">
        <div className="flex flex-col gap-[12] sm:gap-[16]">
          ...
          <div className="w-[276] sm:w-84">
            <p className="text-[1.25rem] sm:text-[1.375rem]">
        ...
        <div className="flex flex-col gap-[12] sm:gap-[16]">
          ...
          <div className="w-44 min-[408]:w-104 min-[1150]:w-104 lg:max-[1150]:w-52">
            <p className="text-[1.25rem] sm:text-[1.375rem]">
      ...
      <div className="relative aspect-375/340 w-full lg:w-[400]">
        <Image
